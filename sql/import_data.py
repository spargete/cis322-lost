...
def import_convoy():
	...
	for s in convoy:
		...
		for j in range(len(vehicles)):
			...
			print("INSERT INTO vehicles (asset_fk) SELECT asset_pk FROM assets AS a WHERE a.asset_tag = '{}';".format(vehicles[j].strip()))
			print("INSERT INTO used_by (convoy_fk) SELECT convoy_pk FROM convoy c WHERE c.request = '{}';".format(s[0]))
			print("UPDATE used_by u SET u.vehicle_fk = (SELECT vehicle_pk FROM vehicles v WHERE v.asset_fk = (SELECT asset_pk FROM assets AS a WHERE a.asset_tag = '{}')) WHERE u.convoy_fk = (SELECT convoy_pk FROM convoy c WHERE c.request = '{}');".format(vehicles[j].strip(), s[0]))
...
def import_DC_inventory():
	...
	for s in DC_inventory:
		...
		print("UPDATE assets AS a SET a.product_fk = (SELECT product_pk FROM products p WHERE p.description = '{}') WHERE a.asset_tag = '{}';".format(s[1], s[0]))
		print("INSERT INTO asset_at (asset_fk) SELECT asset_pk FROM assets AS a WHERE asset_tag = '{}';".format(s[0]))
		print("UPDATE asset_at AS at SET at.arrive_dt = '{}' WHERE asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format('January 10, 2017', s[0]))
		print("UPDATE asset_at AS at SET at.facility_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'HQ') WHERE at.asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format(s[0]))
		tag = s[3].split(":")
		level = tag[1]
		compartment = tag[0]
		print("INSERT INTO security_tags (asset_fk) SELECT asset_pk FROM assets AS a WHERE a.asset_tag = '{}';".format(s[0]))
...
def import_HQ_inventory():
	...
	for i in range(3):
		...
		print("UPDATE assets AS a SET a.product_fk = (SELECT product_pk FROM products p WHERE p.description = '{}') WHERE a.asset_tag = '{}';".format(s[1], s[0]))
		print("INSERT INTO asset_at (asset_fk) SELECT asset_pk FROM assets AS a WHERE asset_tag = '{}';".format(s[0]))
		print("UPDATE asset_at AS at SET at.arrive_dt = '{}' WHERE asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format('January 7, 2017', s[0]))
		print("UPDATE asset_at AS at SET at.facility_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'HQ') WHERE at.asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format(s[0]))
		tag = s[3].split(":")
		level = tag[1]
		compartment = tag[0]
...
def import_MB005_inventory():
	...
	for s in MB005_inventory:
		...
		print("INSERT INTO assets (asset_tag) VALUES ('{}');".format(s[0]))
		print("UPDATE assets AS a SET a.product_fk = (SELECT product_pk FROM products p WHERE p.description = '{}') WHERE a.asset_tag = '{}';".format(s[1], s[0]))
		print("INSERT INTO asset_at (asset_fk) SELECT asset_pk FROM assets AS a WHERE a.asset_tag = '{}';".format(s[0]))
		print("UPDATE asset_at AS at SET at.arrive_dt = '{}' WHERE asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format('December 15, 2016', s[0]))
		print("UPDATE asset_at AS at SET at.depart_dt = '{}' WHERE asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format('December 31, 2019', s[0]))
		print("UPDATE asset_at AS at SET at.facility_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'MB005') WHERE at.asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format(s[0]))
...
def import_NC_inventory():
	...
	print("UPDATE assets AS a SET a.product_fk = (SELECT product_pk FROM products p WHERE p.description = '{}') WHERE a.asset_tag = '{}';".format(s[1], s[0]))
	print("INSERT INTO asset_at (asset_fk) SELECT asset_pk FROM assets AS a WHERE a.asset_tag = '{}';".format(s[0]))
	print("UPDATE asset_at AS at SET at.arrive_dt = '{}' WHERE asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format('January 8, 2017', s[0]))
	print("UPDATE asset_at AS at SET at.depart_dt = '{}' WHERE asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format('December 31, 2020', s[0]))
	print("UPDATE asset_at AS at SET at.facility_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'NC') WHERE at.asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format(s[0]))
	tag = s[3].split(":")
	level = tag[1]
	compartment = tag[0]
	print("INSERT INTO security_tags (asset_fk) SELECT asset_pk FROM assets AS a WHERE a.asset_tag = '{}';".format(s[0]))
	...
	print("INSERT INTO asset_at (asset_fk) SELECT asset_pk FROM assets AS a where a.asset_tag = '{}';".format(s[0]))
	print("UPDATE asset_at AS at SET at.arrive_dt = '{}' WHERE asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format('January 8, 2017', s[0]))
	print("UPDATE asset_at AS at SET at.depart_dt = '{}' WHERE asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format('December 31, 2021', s[0]))
	print("UPDATE asset_at AS at SET at.facility_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'NC') WHERE at.asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format(s[0]))
	...
	print("INSERT INTO asset_at (asset_fk) SELECT asset_pk FROM assets AS a where a.asset_tag = '{}';".format(s[0]))
	print("UPDATE asset_at AS at SET at.arrive_dt = '{}' WHERE asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format('January 8, 2017', s[0]))
	print("UPDATE asset_at AS at SET at.depart_dt = '{}' WHERE asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format('December 31, 2017', s[0]))
	print("UPDATE asset_at AS at SET at.facility_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'NC') WHERE at.asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format(s[0]))
	tag = s[3].split(":")
	level = tag[1]
	compartment = tag[0]
...
def import_SPNV_inventory():
	...
	for i in range(2):
		...
		print("UPDATE assets AS a SET a.product_fk = (SELECT product_pk FROM products p WHERE p.description = '{}') WHERE a.asset_tag = '{}';".format(s[1], s[0]))
		print("INSERT INTO asset_at (asset_fk) SELECT asset_pk FROM assets AS a where a.asset_tag = '{}';".format(s[0]))
		print("UPDATE asset_at AS at SET at.facility_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'SPNV') WHERE at.asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format(s[0]))
		print("UPDATE asset_at AS at SET at.arrive_dt = '{}' WHERE at.asset_fk = (SELECT asset_pk FROM assets WHERE asset_tag = '{}');".format('January 8, 2017', s[0]))
		if i == 0:
			print("INSERT INTO security_tags (asset_fk) SELECT asset_pk FROM assets AS a WHERE a.asset_tag = '{}';".format(s[0]))
...
def import_transit():
	...
	for i in range(7):
		...
		for j in range(len(a)):
			print("INSERT INTO asset_on (asset_fk) SELECT asset_pk FROM assets AS a WHERE a.asset_tag = '{}';".format(a[j].strip()))
			print("UPDATE asset_on AS o SET convoy_fk = (SELECT convoy_pk FROM convoys AS c WHERE c.request = '{}') WHERE o.asset_fk = (SELECT asset_pk FROM assets AS a WHERE a.asset_tag = '{}');".format(s[5], a[j].strip()))
			print("UPDATE asset_on AS o SET load_dt = '{}' WHERE o.asset_fk = (SELECT asset_pk FROM assets AS a WHERE a.asset_tag = '{}');".format(s[3], a[j].strip()))
			print("UPDATE asset_on AS o SET unload_dt = '{}' WHERE o.asset_fk = (SELECT asset_pk FROM assets AS a WHERE a.asset_tag = '{}');".format(s[4],a[j].strip()))

		if i == 0:
			print("UPDATE convoys AS c SET c.source_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'MB005') WHERE c.request = '{}';".format(s[5]))
			print("UPDATE convoys AS c SET c.dest_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'HQ') WHERE c.request = '{}';".format(s[5]))
		
		elif i == 1:
			print("UPDATE convoys AS c SET c.source_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'S300') WHERE c.request = '{}';".format(s[5]))
			print("UPDATE convoys AS c SET c.dest_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'NC') WHERE c.request = '{}';".format(s[5]))

		elif i == 2:
			print("UPDATE convoys AS c SET c.source_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'GL') WHERE c.request = '{}';".format(s[5]))
			print("UPDATE convoys AS c SET c.dest_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'SPNV') WHERE c.request = '{}';".format(s[5]))

		else:
			print("UPDATE convoys AS c SET c.source_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'LANM') WHERE c.request = '{}';".format(s[5]))
			print("UPDATE convoys AS c SET c.dest_fk = (SELECT facility_pk FROM facilities AS f WHERE f.fcode = 'DC') WHERE c.request = '{}';".format(s[5]))
